...
_RGB_VALUE = descriptor.Descriptor(
  name='RGB_Value',
  full_name='fullcircle.RGB_Value',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='red', full_name='fullcircle.RGB_Value.red', index=0,
      number=1, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='green', full_name='fullcircle.RGB_Value.green', index=1,
      number=2, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='blue', full_name='fullcircle.RGB_Value.blue', index=2,
      number=3, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='x', full_name='fullcircle.RGB_Value.x', index=3,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='y', full_name='fullcircle.RGB_Value.y', index=4,
...
_SNIP = descriptor.Descriptor(
  ...
  nested_types=[_SNIP_PINGSNIP, _SNIP_PONGSNIP, _SNIP_ERRORSNIP, _SNIP_REQUESTSNIP, _SNIP_STARTSNIP, _SNIP_FRAMESNIP, _SNIP_ACKSNIP, _SNIP_NACKSNIP, _SNIP_TIMEOUTSNIP, _SNIP_ABORTSNIP, ],
  enum_types=[
    _SNIP_SNIPTYPE,
    _SNIP_ERRORCODETYPE,
  ],
...
_BINARYFRAME.fields_by_name['pixel'].message_type = _RGB_VALUE
...
DESCRIPTOR.message_types_by_name['RGB_Value'] = _RGB_VALUE
...
class RGB_Value(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _RGB_VALUE
